...
/*
	...
	n := gu.SerializeSizeVLQ(num)
	fmt.Println("num:", num, ", len:", n)

	bs := make([]byte, n)
	offset := gu.PutVLQ(bs, num)

	bs = append(bs, []byte("0123456789012345678901234567890")...)
	fmt.Println("bs:", bs, ", offset:", offset)

	num, rc := gu.DeserializeVLQ(bs)
	fmt.Println("num:", num, ", rc:", rc)
*/
