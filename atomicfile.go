// https://godoc.org/github.com/facebookgo/atomicfile

// ref: https://github.com/natefinch/atomic

// Package utils atomicfile provides the ability to write a file with an eventual
